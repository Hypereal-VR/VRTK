        ...
        public SDK_BaseSystem GetSystemSDK()
        {
            ...
            switch (systemSDK)
            {
                ...
                case SupportedSDKs.Simulator:
                    ...
                    break;
                case SupportedSDKs.HyperealVR:
                    returnSDK = ScriptableObject.CreateInstance<SDK_HyperealVRSystem>();
                    break;
                default:
        ...
        public SDK_BaseHeadset GetHeadsetSDK()
        {
            ...
            switch (headsetSDK)
            {
                ...
                case SupportedSDKs.Simulator:
                    ...
                    break;
                case SupportedSDKs.HyperealVR:
                    returnSDK = ScriptableObject.CreateInstance<SDK_HyperealVRHeadset>();
                    break;
                default:
        ...
        public SDK_BaseController GetControllerSDK()
        {
            ...
            switch (controllerSDK)
            {
                ...
                case SupportedSDKs.Simulator:
                    ...
                    break;
                case SupportedSDKs.HyperealVR:
                    returnSDK = ScriptableObject.CreateInstance<SDK_HyperealVRController>();
                    break;
                default:
        ...
        public SDK_BaseBoundaries GetBoundariesSDK()
        {
            ...
            switch (boundariesSDK)
            {
                ...
                case SupportedSDKs.Simulator:
                    ...
                    break;
                case SupportedSDKs.HyperealVR:
                    returnSDK = ScriptableObject.CreateInstance<SDK_HyperealVRBoundaries>();
                    break;
                default:
